<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="RegisterUsers.aspx.cs" Inherits="WebApplication_restful_core.Webforms.RegisterUsers" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row wrapper border-bottom white-bg page-heading" style="opacity: 0.75;">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Ingreso Usuarios</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="col-lg-12">
                <div class="ibox float-e-margins registerbody" style="opacity: 0.75; width: 90%; height: 80%;">
                    ...
                    <div class="ibox-content registerbodylogin">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div style="">
                                            ...
                                            <asp:TextBox ID="firstName" name="firstName" class="form-control transparent-input validate" placeholder="Ingrese sus nombres" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div style="">
                                            <asp:Button ID="Button1" runat="server" class="btn btn-primary" AutoPostBack="false" OnClick="btn_saveContact" Text="Grabar"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
